...
fprintf(fid, '%30s \t %s \t %30s  \t %5.4f \t %5.4f \t %5.4f \t %5.4f \t %5.4f \t %5.4f  \t %5.4f  \n','\epsilon_{m_{16}}','measurement error 16',bayestopt_.name{14}, bayestopt_.pshape(14), oo_.prior.mean(14), ALLSTPRIOR(14), oo_.posterior_mean.shocks_std.me16, oo_.posterior_median.shocks_std.me16, oo_.posterior_mode.shocks_std.me16, oo_.posterior_std.shocks_std.me16);
 ...
 fprintf(fid, '%30s \t %s \t %30s  \t %5.4f \t %5.4f \t %5.4f \t %5.4f \t %5.4f \t %5.4f  \t %5.4f  \n','Collateral Policy weight on B. Loan Delinq. Rate','\alpha_{\phi_{e}}',bayestopt_.name{30}, bayestopt_.pshape(30), oo_.prior.mean(30), ALLSTPRIOR(30), oo_.posterior_mean.parameters.alphakomegae, oo_.posterior_median.parameters.alphakomegae, oo_.posterior_mode.parameters.alphakomegae, oo_.posterior_std.parameters.alphakomegae);
 fprintf(fid, '%30s \t %s \t %30s  \t %5.4f \t %5.4f \t %5.4f \t %5.4f \t %5.4f \t %5.4f  \t %5.4f  \n','Collateral Policy weight on R. E. Loan Delinq. Rate','\alpha_{\phi_{h}}',bayestopt_.name{31}, bayestopt_.pshape(31), oo_.prior.mean(31), ALLSTPRIOR(31), oo_.posterior_mean.parameters.alphakomegah, oo_.posterior_median.parameters.alphakomegah, oo_.posterior_mode.parameters.alphakomegah, oo_.posterior_std.parameters.alphakomegah);
 fprintf(fid, '%30s \t %s \t %30s  \t %5.4f \t %5.4f \t %5.4f \t %5.4f \t %5.4f \t %5.4f  \t %5.4f  \n','Collateral Policy weight on B. Loan','\alpha_{m_{e}}',bayestopt_.name{32}, bayestopt_.pshape(32), oo_.prior.mean(32), ALLSTPRIOR(32), oo_.posterior_mean.parameters.alpha_mm_e, oo_.posterior_median.parameters.alpha_mm_e, oo_.posterior_mode.parameters.alpha_mm_e, oo_.posterior_std.parameters.alpha_mm_e);
 fprintf(fid, '%30s \t %s \t %30s  \t %5.4f \t %5.4f \t %5.4f \t %5.4f \t %5.4f \t %5.4f  \t %5.4f  \n','Collateral Policy weight on R. E. Loan','\alpha_{d_{h}}',bayestopt_.name{33}, bayestopt_.pshape(33), oo_.prior.mean(33), ALLSTPRIOR(33), oo_.posterior_mean.parameters.alpha_mm_h, oo_.posterior_median.parameters.alpha_mm_h, oo_.posterior_mode.parameters.alpha_mm_h, oo_.posterior_std.parameters.alpha_mm_h);
