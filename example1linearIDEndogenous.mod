...
rhosigmaomegae_ss = 0.52000000000000;
rhosigmaomegah_ss = 0.52000000000000;
...
omegah_v + d_h_v  -  re_v =  kappah_v +  Qh_v +   hh_v   - PP_v; //- PP_v;

omegae_v + m_v  -  re_v =   kappae_v   +  RK_v(+1) +  QK_v  +   K_v   - PP_v; //- PP_v;
...
//rhosigmaomegae_ss, BETA_PDF, 0.8, 0.1; 
//rhosigmaomegah_ss, BETA_PDF, 0.8, 0.1; 
