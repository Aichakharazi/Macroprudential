...
rhosigmaomegae_ss1 rhosigmaomegah_ss1
rhosigmaomegae_ss rhosigmaomegah_ss 
rhosigmakappae_ss rhosigmakappah_ss
...
//rhosigmaomegae_ss= 0.1560
//rhosigmaomegah_ss= 0.1883
...
rhosigmakappae_ss = 0.7;
rhosigmakappah_ss = 0.7;
...
rhosigmaomegae_ss1 = omegae_ss/(Y_ss-R_ss-RK_ss);
rhosigmaomegah_ss1 = omegah_ss/(Y_ss-R_ss-RK_ss);
...
//omegah_v + d_h_v  -  re_v =  kappah_v +  Qh_v +   hh_v   ; //- PP_v;

//omegae_v + m_v  -  re_v =   kappae_v   +  RK_v(+1) +  QK_v  +   K_v   ; //- PP_v;

omegah_v =- d_h_v  +  re_v  +inflation1_v  + kappah_v +  Qh_v +   hh_v  ; //- PP_v;

omegae_v =- m_v  + re_v    +inflation1_v  +    kappae_v   +  RK_v(+1) +  QK_v  +   K_v  ; //- PP_v;

//1/omegae_ss*omegae_v  =  - 1/Y_ss* Y_v    +  1/WW_ss * WW_v  +  1/d_h_ss * d_h_v   ; //  1/omegae_ss* rhosigmaomegae_ss*omegae_v(-1)  +1/RK_ss *RK_v(+1) + 1/R_ss *R_v(-1)   -1/RK_ss *RK_v(+1)   -  1/WW_ss * WW_v(+1)     ;
//1/omegae_ss*omegah_v  =  - 1/Y_ss* Y_v    +  1/WW_ss * WW_v  +  1/m_ss   * m_v     ; // 1/omegae_ss*  rhosigmaomegah_ss*omegah_v(-1) +1/RK_ss *RK_v(+1)+ 1/R_ss *R_v(-1) -1/RK_ss *RK_v(+1) - 1/WW_ss * WW_v(+1) ;


// 1/omegae_ss* omegae_v  =  ( 1/Y_ss* Y_v(-1)  - 1/R_ss *R_v  -1/RK_ss *RK_v  ) ;//-  1/d_h_ss * d_h_v(+1)  - 1/re_ss * re_v(+1)  ; //  -1/RK_ss *RK_v(+1) - 1/WW_ss * WW_v(+1)  + 1/omegae_ss* rhosigmaomegae_ss*omegae_v(-1)  +1/RK_ss *RK_v(+1) + 1/R_ss *R_v(-1)   -1/RK_ss *RK_v(+1)   -  1/WW_ss * WW_v(+1)     ;
// 1/omegah_ss* omegah_v  =   (  1/Y_ss* Y_v(-1)   - 1/R_ss *R_v- -1/RK_ss *RK_v  ); //- 1/m_ss   * m_v(+1)   - 1/re_ss * re_v(+1) ; //  -1/RK_ss *RK_v(+1) - 1/WW_ss * WW_v(+1) +  1/omegae_ss*  rhosigmaomegah_ss*omegah_v(-1) +1/RK_ss *RK_v(+1)+ 1/R_ss *R_v(-1) -1/RK_ss *RK_v(+1) - 1/WW_ss * WW_v(+1) ;
...
cu_v   =  WW_v  +  Lu_v  -  dep_h_v   +dep_h_v(-1)   +   R_v(-1) - ( PP_v - PP_v(-1)) ;
- dep_h_v(-1)  +  d_h_v ;
//5/27/2022
...
check;
model_diagnostics;
stoch_simul(order=1,irf=151, nograph);
...
//alphakomegae,  BETA_PDF, 0.25, 0.1;
//alphakomegah, BETA_PDF, 0.25, 0.1;
...
//estimation(datafile=datalogdiff84,mode_check,diffuse_filter,mh_nblocks=4,mh_replic=10000,mh_jscale=3,mh_init_scale=0.2,mode_compute=1, moments_varendo, bayesian_irf, conf_sig=0.90)gdpobs, consumptionobs,
//Hloan_obs, CIloan_obs, 
//govobs,
//default_h_obs default_e_obs
//investobs
...
save irf_plot_with_policyendogenous c_v_e7 c_v_e6 ...
Y_v_e6 Y_v_e7...
L_v_e6 L_v_e7...
m_v_e6 m_v_e7...
d_h_v_e6 d_h_v_e7...
Y_v_e19 L_v_e19 c_v_e19 d_h_v_e19  m_v_e19...
omegae_v_e19 omegae_v_e6 ...
omegah_v_e19 omegah_v_e7...
